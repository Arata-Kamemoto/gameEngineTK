...
void Game::Render()
{
	...
	primitiveBatch->DrawLine(VertexPositionColor(SimpleMath::Vector3(0, 300, 0), SimpleMath::Color(0, 0, 0)), VertexPositionColor(SimpleMath::Vector3(400,300,0),SimpleMath::Color(1,1,1)));
	primitiveBatch->End();
